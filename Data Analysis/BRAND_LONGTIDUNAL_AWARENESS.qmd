...
library(readr)
Brand_awareness_longtidunal_point_estimate <- read_csv("Brand_awareness_longtidunal_point_estimate.csv")
...
```{r}
require(dplyr)
Brand_awareness_longtidunal_point_estimate_reduced<-dplyr::select(Brand_awareness_longtidunal_point_estimate,ResponseId,Q75_SHARED_1,Q75_SHARED_2,Q75_SHARED_3,Q75_SHARED_4,Q75_SHARED_5,Q75_SHARED_6,Q75_SHARED_7,Q75_SHARED_8,Year,Quarter,LOB,WAVE)
...
Brand_awareness_longtidunal_point_estimate_reduced<-replace_NA_with_value(
  Brand_awareness_longtidunal_point_estimate_reduced,
  columns = c("Q75_SHARED_1",  ),replace_value=0)
