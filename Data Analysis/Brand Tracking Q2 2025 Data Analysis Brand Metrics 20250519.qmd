...
BTQ2_REVISED_REDUCED_FIGS_data_numeric<- lapply(BTQ2_REVISED_REDUCED_FIGS_factorized, function(x) as.numeric(as.factor(x)))
BTQ2_REVISED_REDUCED_FIGS_data_numeric<-data.frame(BTQ2_REVISED_REDUCED_FIGS_data_numeric) 

# Replace NA values in columns A and B with 999
BTQ2_REVISED_REDUCED_data_numeric_replaced <- replace_NA_with_value(BTQ2_REVISED_REDUCED_FIGS_data_numeric, columns = c("q75_shared_1","q75_shared_2",  "q75_shared_3","q75_shared_4","q75_shared_5","q75_shared_6"
,"q75_shared_7","q75_shared_8"), replace_value = 0)

# Print the result dataframe
BTQ2_REVISED_REDUCED_data_numeric_replaced


BTQ2_REVISED_REDUCED_data_numeric_replaced$response_id <- BTQ2_REVISED_REDUCED_FIGS$response_id

# View the updated df2
BTQ2_REVISED_REDUCED_data_numeric_replaced$response_id<-as.factor(BTQ2_REVISED_REDUCED_data_numeric_replaced$response_id)
BTQ2_REVISED_REDUCED_data_numeric_replaced
```
...
require(dplyr)
#Awareness
BRAND_AWARE_DF<-dplyr::select(BTQ2_REVISED_REDUCED_data_numeric_replaced,response_id,q75_shared_1,q75_shared_2,
                                                       q75_shared_3,q75_shared_4,q75_shared_5,q75_shared_6,q75_shared_7,q75_shared_8)
BRAND_AWARE_DF
#Future Consideration
BRAND_FUTURE_CON_DF<-dplyr::select(BTQ2_REVISED_REDUCED_data_numeric_replaced,response_id,q40_shared_1,q40_shared_2,q40_shared_3,q40_shared_4,q40_shared_5, q40_shared_6,q40_shared_7,q40_shared_8)
BRAND_FUTURE_CON_DF

#NPS
BRAND_NPS_DF<-dplyr::select(BTQ2_REVISED_REDUCED_data_numeric_replaced,response_id,q43_shared_1,q43_shared_2,q43_shared_3,q43_shared_4,q43_shared_5,q43_shared_6,q43_shared_7,q43_shared_8)
BRAND_NPS_DF
...
create_bubble_plot_jitter(mean_data_brand_data,
                   ...
                   x_label = "% Awareness",
                   y_label = "Mean NPS",
                   x_min = 0, x_max = 40,  # Changed to 0.20 for 20%
                   y_min = 1, y_max = 5,
                   label_symbol = "%",
...
```{r}
require(dplyr)
BTQ2_REVISED_REDUCED <-dplyr::select(BTQ2,response_id,RESPONDENT_TYPE,q75_shared_1,q75_shared_2,
                                                       q75_shared_3,q75_shared_4,q75_shared_5,q75_shared_6
...
BTQ2_REVISED_REDUCED_data_survey_factorized <- lapply(BTQ2_REVISED_REDUCED, function(x) as.factor(as.character(x)))
BTQ2_REVISED_REDUCED_data_survey_factorized<-data.frame(BTQ2_REVISED_REDUCED_data_survey_factorized) 
...
BTQ2_REVISED_REDUCED_data_survey_factorized[paste0("q38_shared_", 1:8)] <- lapply(BTQ2_REVISED_REDUCED_data_survey_factorized[paste0("q38_shared_", 1:8)], function(x) {
...
# Use lapply to apply the same transformation to all q40_shared variables
BTQ2_REVISED_REDUCED_data_survey_factorized[paste0("q40_shared_", 1:8)] <- lapply(BTQ2_REVISED_REDUCED_data_survey_factorized[paste0("q40_shared_", 1:8)], function(x) {
  factor(x, levels = q40_correct_levels, labels = q40_correct_levels, ordered = TRUE)
})



BTQ2_REVISED_REDUCED_data_numeric<- lapply(BTQ2_REVISED_REDUCED_data_survey_factorized, function(x) as.numeric(as.factor(x)))
BTQ2_REVISED_REDUCED_data_numeric<-data.frame(BTQ2_REVISED_REDUCED_data_numeric) 

# Replace NA values in columns A and B with 999
BTQ2_REVISED_REDUCED_data_numeric_replaced <- replace_NA_with_value(BTQ2_REVISED_REDUCED_data_numeric, columns = c("q75_shared_1","q75_shared_2",  "q75_shared_3","q75_shared_4","q75_shared_5","q75_shared_6"
,"q75_shared_7","q75_shared_8","q41_shared_1","q41_shared_2","q41_shared_3","q41_shared_4","q41_shared_5","q41_shared_6","q41_shared_7","q41_shared_8"), replace_value = 0)
...
```{r}
require(dplyr)
BTQ2_REVISED_AWARENESS_REDUCED<-dplyr::select(BTQ2,response_id,RESPONDENT_TYPE,q75_shared_1,q75_shared_2,q75_shared_3,q75_shared_4,q75_shared_5,q75_shared_6,q75_shared_7,q75_shared_8)



# Replace NA values in columns A and B with 999
BTQ2_REVISED_AWARENESS_REDUCED <- replace_NA_with_value(BTQ2_REVISED_AWARENESS_REDUCED, columns = c("q75_shared_1","q75_shared_2",  "q75_shared_3","q75_shared_4","q75_shared_5","q75_shared_6"
,"q75_shared_7","q75_shared_8"), replace_value = '0')
BTQ2_REVISED_AWARENESS_REDUCED


# Call the function with the sample data
result <- compute_binary_percentages(BTQ2_REVISED_AWARENESS_REDUCED, subset_var = "RESPONDENT_TYPE",q75_shared_1,q75_shared_2,  q75_shared_3,q75_shared_4,q75_shared_5,q75_shared_6
,q75_shared_7,q75_shared_8)
# Print the result
print(result)
```

Now we will factor respondent id and respondent type

```{r}
BTQ2_REVISED_REDUCED_data_numeric_replaced$response_id<-as.factor(BTQ2_REVISED_REDUCED_data_numeric_replaced$response_id)
BTQ2_REVISED_REDUCED_data_numeric_replaced$RESPONDENT_TYPE<-as.factor(BTQ2_REVISED_REDUCED_data_numeric_replaced$RESPONDENT_TYPE)
```

```{r}
BTQ2_REVISED_REDUCED_data_numeric_replaced$RESPONDENT_TYPE<-factor(BTQ2_REVISED_REDUCED_data_numeric_replaced$RESPONDENT_TYPE,
  levels = c(1,2),
  labels = c("CL","PL")
)
BTQ2_REVISED_REDUCED_data_numeric_replaced
...
```{r}
BTQ2_REVISED_REDUCED_data_numeric_replaced_CL<-subset(BTQ2_REVISED_REDUCED_data_numeric_replaced,RESPONDENT_TYPE=="CL")
colnames(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL)
```

### Personal Lines

```{r}
BTQ2_REVISED_REDUCED_data_numeric_replaced_PL<-subset(BTQ2_REVISED_REDUCED_data_numeric_replaced,RESPONDENT_TYPE=="PL")
BTQ2_REVISED_REDUCED_data_numeric_replaced_PL
```
...
#Mean Awareness
#Acrisure
  ACRISURE_AWARE_MEAN_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q75_shared_1,na.rm=TRUE)/nrow(BTQ2))*100
  ACRISURE_AWARE_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q75_shared_1,na.rm=TRUE)/nrow(BTQ2_CL))*100
  ACRISURE_AWARE_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q75_shared_1,na.rm=TRUE)/nrow(BTQ2_PL))*100
  #Aon
  AON_AWARE_MEAN_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q75_shared_2,na.rm=TRUE)/nrow(BTQ2))*100
  AON_AWARE_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q75_shared_2,na.rm=TRUE)/nrow(BTQ2_CL))*100
  AON_AWARE_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q75_shared_2,na.rm=TRUE)/nrow(BTQ2_PL))*100
  #AJG
  AJG_AWARE_MEAN_SUM_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q75_shared_3,na.rm=TRUE)/nrow(BTQ2))*100
  AJG_AWARE_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q75_shared_3,na.rm=TRUE)/nrow(BTQ2_CL))*100
  AJG_AWARE_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q75_shared_3,na.rm=TRUE)/nrow(BTQ2_PL))*100
  #Brown & Brown
  BROWN_BROWN_AWARE_MEAN_SUM_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q75_shared_4,na.rm=TRUE)/nrow(BTQ2))*100
  BROWN_BROWN_AWARE_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q75_shared_4,na.rm=TRUE)/nrow(BTQ2_CL))*100
  BROWN_BROWN_AWARE_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q75_shared_4,na.rm=TRUE)/nrow(BTQ2_PL))*100
  #Hub International
  HUB_AWARE_MEAN_SUM_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q75_shared_5,na.rm=TRUE)/nrow(BTQ2))*100
  HUB_AWARE_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q75_shared_5,na.rm=TRUE)/nrow(BTQ2_CL))*100
  HUB_AWARE_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q75_shared_5,na.rm=TRUE)/nrow(BTQ2_PL))*100
  #Lockton and Companies
  LOCKTON_AWARE_MEAN_SUM_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q75_shared_6,na.rm=TRUE)/nrow(BTQ2))*100
  LOCKTON_AWARE_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q75_shared_6,na.rm=TRUE)/nrow(BTQ2_CL))*100
  LOCKTON_AWARE_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q75_shared_6,na.rm=TRUE)/nrow(BTQ2_PL))*100
  #Marsh McLennan
  MM_AWARE_MEAN_SUM_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q75_shared_7,na.rm=TRUE)/nrow(BTQ2))*100
  MM_AWARE_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q75_shared_7,na.rm=TRUE)/nrow(BTQ2_CL))*100
  MM_AWARE_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q75_shared_7,na.rm=TRUE)/nrow(BTQ2_PL))*100
  #WTW
  WTW_AWARE_MEAN_SUM_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q75_shared_8,na.rm=TRUE)/nrow(BTQ2))*100
  WTW_AWARE_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q75_shared_8,na.rm=TRUE)/nrow(BTQ2_CL))*100
  WTW_AWARE_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q75_shared_8,na.rm=TRUE)/nrow(BTQ2_PL))*100
  #Mean customer experience
  #Acrisure
  ACRISURE_CUSTOMER_EXPERIENCE_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q38_shared_1,na.rm=TRUE)
  ACRISURE_CUSTOMER_EXPERIENCE_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q38_shared_1,na.rm=TRUE)
  ACRISURE_CUSTOMER_EXPERIENCE_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q38_shared_1,na.rm=TRUE)
  #Aon
  AON_CUSTOMER_EXPERIENCE_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q38_shared_2,na.rm=TRUE)
  AON_CUSTOMER_EXPERIENCE_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q38_shared_2,na.rm=TRUE)
  AON_CUSTOMER_EXPERIENCE_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q38_shared_2,na.rm=TRUE)
  #AJG
  AJG_CUSTOMER_EXPERIENCE_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q38_shared_3,na.rm=TRUE)
  AJG_CUSTOMER_EXPERIENCE_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q38_shared_3,na.rm=TRUE)
  AJG_CUSTOMER_EXPERIENCE_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q38_shared_3,na.rm=TRUE)
  #Brown & Brown
  BROWN_BROWN_CUSTOMER_EXPERIENCE_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q38_shared_4,na.rm=TRUE)
  BROWN_BROWN_CUSTOMER_EXPERIENCE_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q38_shared_4,na.rm=TRUE)
  BROWN_BROWN_CUSTOMER_EXPERIENCE_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q38_shared_4,na.rm=TRUE)
  #Hub International
  HUB_CUSTOMER_EXPERIENCE_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q38_shared_5,na.rm=TRUE)
  HUB_CUSTOMER_EXPERIENCE_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q38_shared_5,na.rm=TRUE)
  HUB_CUSTOMER_EXPERIENCE_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q38_shared_5,na.rm=TRUE)
  #Lockton and Companies
  LOCKTON_CUSTOMER_EXPERIENCE_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q38_shared_6,na.rm=TRUE)
  LOCKTON_CUSTOMER_EXPERIENCE_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q38_shared_6,na.rm=TRUE)
  LOCKTON_CUSTOMER_EXPERIENCE_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q38_shared_6,na.rm=TRUE)
  #Marsh McLenna
  MM_CUSTOMER_EXPERIENCE_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q38_shared_7,na.rm=TRUE)
  MM_CUSTOMER_EXPERIENCE_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q38_shared_7,na.rm=TRUE)
  MM_CUSTOMER_EXPERIENCE_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q38_shared_7,na.rm=TRUE)
  #WTW
  WTW_CUSTOMER_EXPERIENCE_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q38_shared_8,na.rm=TRUE)
  WTW_CUSTOMER_EXPERIENCE_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q38_shared_8,na.rm=TRUE)
  WTW_CUSTOMER_EXPERIENCE_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q38_shared_8,na.rm=TRUE)
  #Mean future consideration
  #Acrisure
  ACRISURE_FUTURE_CONSIDERATION_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q40_shared_1,na.rm=TRUE)
  ACRISURE_FUTURE_CONSIDERATION_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q40_shared_1,na.rm=TRUE)
  ACRISURE_FUTURE_CONSIDERATION_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q40_shared_1,na.rm=TRUE)
  #Aon
  AON_FUTURE_CONSIDERATION_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q40_shared_2,na.rm=TRUE)
  AON_FUTURE_CONSIDERATION_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q40_shared_2,na.rm=TRUE)
  AON_FUTURE_CONSIDERATION_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q40_shared_2,na.rm=TRUE)
  #AJG
  AJG_FUTURE_CONSIDERATION_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q40_shared_3,na.rm=TRUE)
  AJG_FUTURE_CONSIDERATION_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q40_shared_3,na.rm=TRUE)
  AJG_FUTURE_CONSIDERATION_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q40_shared_3,na.rm=TRUE)
  #Brown & Brown
  BROWN_BROWN_FUTURE_CONSIDERATION_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q40_shared_4,na.rm=TRUE)
  BROWN_BROWN_FUTURE_CONSIDERATION_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q40_shared_4,na.rm=TRUE)
  BROWN_BROWN_FUTURE_CONSIDERATION_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q40_shared_4,na.rm=TRUE)
  #Hub International
  HUB_FUTURE_CONSIDERATION_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q40_shared_5,na.rm=TRUE)
  HUB_FUTURE_CONSIDERATION_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q40_shared_5,na.rm=TRUE)
  HUB_FUTURE_CONSIDERATION_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q40_shared_5,na.rm=TRUE)
  #Lockton and Companies
  LOCKTON_FUTURE_CONSIDERATION_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q40_shared_6,na.rm=TRUE)
  LOCKTON_FUTURE_CONSIDERATION_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q40_shared_6,na.rm=TRUE)
  LOCKTON_FUTURE_CONSIDERATION_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q40_shared_6,na.rm=TRUE)
  #Marsh McLennan
  MM_FUTURE_CONSIDERATION_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q40_shared_7,na.rm=TRUE)
  MM_FUTURE_CONSIDERATION_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q40_shared_7,na.rm=TRUE)
  MM_FUTURE_CONSIDERATION_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q40_shared_7,na.rm=TRUE)
  #WTW
  WTW_FUTURE_CONSIDERATION_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q40_shared_8,na.rm=TRUE)
  WTW_FUTURE_CONSIDERATION_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q40_shared_8,na.rm=TRUE)
  WTW_FUTURE_CONSIDERATION_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q40_shared_8,na.rm=TRUE)
  ###Ad Exposure
  #Acrisure
  ACRISURE_Ad_Exposure_MEAN_SUM_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q41_shared_1,na.rm=TRUE)/nrow(BTQ2))*100
  ACRISURE_Ad_Exposure_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q41_shared_1,na.rm=TRUE)/nrow(BTQ2_CL))*100
  ACRISURE_Ad_Exposure_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q41_shared_1,na.rm=TRUE)/nrow(BTQ2_PL))*100
  #Aon
  AON_Ad_Exposure_MEAN_SUM_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q41_shared_2,na.rm=TRUE)/nrow(BTQ2))*100
  AON_Ad_Exposure_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q41_shared_2,na.rm=TRUE)/nrow(BTQ2_CL))*100
  AON_Ad_Exposure_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q41_shared_2,na.rm=TRUE)/nrow(BTQ2_PL))*10
  #AJG
  AJG_Ad_Exposure_MEAN_SUM_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q41_shared_3,na.rm=TRUE)/nrow(BTQ2))*100
  AJG_Ad_Exposure_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q41_shared_3,na.rm=TRUE)/nrow(BTQ2_CL))*100
  AJG_Ad_Exposure_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q41_shared_3,na.rm=TRUE)/nrow(BTQ2_PL))*100
  #Brown & Brown
  BROWN_BROWN_Ad_Exposure_MEAN_SUM_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q41_shared_4,na.rm=TRUE)/nrow(BTQ2))*100
  BROWN_BROWN_Ad_Exposure_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q41_shared_4,na.rm=TRUE)/nrow(BTQ2_CL))*100
  BROWN_BROWN_Ad_Exposure_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q41_shared_4,na.rm=TRUE)/nrow(BTQ2_PL))*100
  #Hub International
  HUB_Ad_Exposure_MEAN_SUM_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q41_shared_5,na.rm=TRUE)/nrow(BTQ2))*100
  HUB_Ad_Exposure_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q41_shared_5,na.rm=TRUE)/nrow(BTQ2_CL))*100
  HUB_Ad_Exposure_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q41_shared_5,na.rm=TRUE)/nrow(BTQ2_PL))*100
  #Lockton and Companies
  LOCKTON_Ad_Exposure_MEAN_SUM_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q41_shared_6,na.rm=TRUE)/nrow(BTQ2))*100
  LOCKTON_Ad_Exposure_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q41_shared_6,na.rm=TRUE)/nrow(BTQ2_CL))*100
  LOCKTON_Ad_Exposure_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q41_shared_6,na.rm=TRUE)/nrow(BTQ2_PL))*100
  #Marsh McLennan
  MM_Ad_Exposure_MEAN_SUM_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q41_shared_7,na.rm=TRUE)/nrow(BTQ2))*100
  MM_Ad_Exposure_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q41_shared_7,na.rm=TRUE)/nrow(BTQ2_CL))*100
  MM_Ad_Exposure_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q41_shared_7,na.rm=TRUE)/nrow(BTQ2_PL))*100
  #WTW
  WTW_Ad_Exposure_MEAN_SUM_COMPOSITE<-(sum(BTQ2_REVISED_REDUCED_data_numeric$q41_shared_8,na.rm=TRUE)/nrow(BTQ2))*100
  WTW_Ad_Exposure_MEAN_CL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q41_shared_8,na.rm=TRUE)/nrow(BTQ2_CL))*100
  WTW_Ad_Exposure_MEAN_PL<-(sum(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q41_shared_8,na.rm=TRUE)/nrow(BTQ2_PL))*100
  
  ###Mean NPS
  #Acrisure
  ACRISURE_NPS_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q43_shared_1,na.rm=TRUE)
  ACRISURE_NPS_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q43_shared_1,na.rm=TRUE)
  ACRISURE_NPS_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q43_shared_1,na.rm=TRUE)
  #Aon
  AON_NPS_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q43_shared_2,na.rm=TRUE)
  AON_NPS_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q43_shared_2,na.rm=TRUE)
  AON_NPS_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q43_shared_2,na.rm=TRUE)
  #AJG
  AJG_NPS_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q43_shared_3,na.rm=TRUE)
  AJG_NPS_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q43_shared_3,na.rm=TRUE)
  AJG_NPS_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q43_shared_3,na.rm=TRUE)
  #Brown & Brown
  BROWN_BROWN_NPS_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q43_shared_4,na.rm=TRUE)
  BROWN_BROWN_NPS_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q43_shared_4,na.rm=TRUE)
  BROWN_BROWN_NPS_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q43_shared_4,na.rm=TRUE)
  #Hub International
  HUB_NPS_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q43_shared_5,na.rm=TRUE)
  HUB_NPS_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q43_shared_5,na.rm=TRUE)
  HUB_NPS_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q43_shared_5,na.rm=TRUE)
  #Lockton and Companies
  LOCKTON_NPS_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q43_shared_6,na.rm=TRUE)
  LOCKTON_NPS_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q43_shared_6,na.rm=TRUE)
  LOCKTON_NPS_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q43_shared_6,na.rm=TRUE)
  #Marsh McLennan
  MM_NPS_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q43_shared_7,na.rm=TRUE)
  MM_NPS_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q43_shared_7,na.rm=TRUE)
  MM_NPS_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q43_shared_7,na.rm=TRUE)
  #WTW
  WTW_NPS_MEAN_SUM_COMPOSITE<-mean(BTQ2_REVISED_REDUCED_data_numeric$q43_shared_8,na.rm=TRUE)
  WTW_NPS_MEAN_CL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_CL$q43_shared_8,na.rm=TRUE)
  WTW_NPS_MEAN_PL<-mean(BTQ2_REVISED_REDUCED_data_numeric_replaced_PL$q43_shared_8,na.rm=TRUE)
```
...
library(tidyverse)
library(scales)
NPS_CL_DF<-dplyr::select(BTQ2_CL,response_id,q43_shared_1,q43_shared_2,q43_shared_3,q43_shared_4,q43_shared_5,q43_shared_6,q43_shared_7,q43_shared_8,q43_shared_12,q43_shared_13,q43_shared_14,q43_shared_15)
...
levels = c("q43_shared_1","q43_shared_2","q43_shared_3","q43_shared_4","q43_shared_5","q43_shared_6","q43_shared_7","q43_shared_8","q43_shared_12","q43_shared_13","q43_shared_14","q43_shared_15"),    
labels = c("Acrisure","Aon","Arthur J. Gallagher & Co.","Brown & Brown","Hub International","Lockton Companies","Marsh McLennan","WTW","SoFi","Insureon","Hiscox","Intuit QuickBooks"))
...
order_names <- c("WTW","Brown & Brown","Marsh McLennan","Insureon","Acrisure","Aon","Lockton Companies","Arthur J. Gallagher & Co.","Hub International","SoFi","Hiscox","Intuit QuickBooks")
